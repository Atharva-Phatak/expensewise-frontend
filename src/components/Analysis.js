  ...
  return (
    <div className="">
      {props.clicked ? (
        ...
        <div className="w-3/4 m-auto lg:mt-10 bg-black p-5 rounded-md">
        ...
        <ul className="flex  lg:pb-0 pb-8 lg:px-0 lg:-ml-10 space-x-3 lg:space-x-10">
          <button onClick={changeButton1}>
            <li
              className={
                active === "1"
                  ? "bg-rose-600 py-3 px-5 rounded-md text-white font-bold"
                  : "border border-rose-600 py-3 px-5 rounded-md text-white font-bold "
              }
            >
              1 Month
            </li>
