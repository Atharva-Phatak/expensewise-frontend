    ...
    <Scrollbars style={{ width: 540, height: 500 }} className="mt-8">
      <div className=" grid grid-cols-6 font-lexend ">
        <div className="col-span-4 bg-black p-6 ">
          ...
          <div>
            <input
              className="p-3 px-4 rounded-md mt-6  w-3/4 placeholder-white bg-black outline-none text-white border-2 border-rose-600"
          ...
          <div>
            <h1 className="text-white font-bold  mt-4">Category</h1>
          </div>
          ...
          <div className="border-rose-600 border-2 rounded-md w-fit px-8 mt-10">
            {isLoading ? (
              <ReactLoading
                type="bubbles"
                color="#F5A302"
