...
export default function DashBoard(props) {
  ...
  return (
    <div>
      <div className="bg-black lg:grid lg:grid-cols-5 h-screen font-lexend overflow-y-scroll overflow-x-clip">
        <div className="col-span-1 p-4 bg-black text-white">
          <div className="lg:inline flex">
            <Link to="/">
              <ul className="cursor-pointer">
                <li className="px-2 mt-2 py-1">
                  <h1 className="lg:text-3xl text-lg font-bold">ExpenseWise</h1>
                </li>
              </ul>
            </Link>
            <ul className="lg:flex lg:flex-col mt-10 hidden">
              <Link to="/dashboard">
                <li
                  ...
                  className={
                    active === "1"
                      ? "mb-4 flex px-5 py-3 cursor-pointer text-2xl hover:bg-jp-black hover:rounded-md bg-black rounded-md"
            ...
            <div className="lg:hidden flex">
              <button
                className="ml-32 bg-rose-600 rounded-lg "
        ...
        <div
          ...
          className={isMobile ? "hidden bg-black" : "inline bg-black"}
        >
            ...
            <ul className="">
              ...
              <div className="ml-6  mt-4 bottom-5 left-16 pb-6 ">
                <button
                  ...
                  className="bg-rose-600 px-4 py-3 flex rounded-md font-bold duration-300 ease-out hover:scale-110"
                >
                  <span>
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
        ...
        <div className=" lg:block absolute bottom-14 z-50 right-5 lg:bottom-20 lg:left-16 lg:right-0">
          <button
            ...
            className="bg-rose-600 px-4 py-3 flex rounded-md font-bold duration-300 ease-out hover:scale-110 text-white"
          >
            <span>
              <svg
                xmlns="http://www.w3.org/2000/svg"
